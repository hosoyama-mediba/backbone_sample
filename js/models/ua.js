/**
 * @fileOverview UserAgentから端末情報を取得する
 *
 * 一時的にuupaa氏のUserAgent.jsをコピーしていますが将来的に内製化します
 *
 * https://github.com/uupaa/UserAgent.js/blob/master/lib/WebModule.js
 * https://github.com/uupaa/UserAgent.js/blob/master/lib/UserAgent.js
 *
 * @file         models/userAgent
...
define([
    ...
    return new UserAgent(navigator.userAgent); // return entity
});
